...
export function CelestialInfo() {
  ...
  const metrics: { label: string; value: string | number }[] = [
    { label: "当前时间", value: celestialData.current_time || "N/A" },
    { label: "温度", value: celestialData.weather.temperature || "N/A" },
    { label: "湿度", value: celestialData.weather.humidity || "N/A" },
    { label: "气压", value: celestialData.weather.pressure || "N/A" },
    { label: "云量", value: celestialData.weather.cloud_cover || "N/A" },
  ];
