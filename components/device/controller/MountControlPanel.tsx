...
export const MountControlPanel: React.FC = () => {
  ...
  return (
    <motion.div 
      ref={setNodeRef}
      className={`${styles.mountControlPanel} ${nightMode ? styles.nightMode : ''}`}
      style={{ 
        width: `${size.width}px`, 
    ...
    >
      ...
      <div className={`${styles.connectionStatus} ${useMountStore.getState().isConnected ? styles.connected : styles.disconnected}`}>
