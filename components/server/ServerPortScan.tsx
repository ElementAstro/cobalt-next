...
import { ScanHistory, ScanResult, usePortScanStore } from "@/lib/store/server";
...
const ServerPortScanModal: React.FC<{
  ...
  const startScan = async () => {
    try {
      await ipSchema.validate(ipAddress);
    } catch (error: any) {
      toast({
        title: "错误",
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-2xl relative max-h-screen overflow-y-auto"
          >
            <Button
              onClick={onClose}
              variant="ghost"
            ...
            <Tabs defaultValue="scan" className="w-full">
              ...
              <TabsContent value="scan">
                ...
                >
                  ...
                  <div>
                    <Label>端口范围</Label>
                    <RadioGroup value={portRange} onValueChange={setPortRange}>
                  ...
                  <div>
                    ...
                    <Select value={scanSpeed} onValueChange={setScanSpeed}>
                      ...
                      <SelectContent>
                        <SelectItem value="fast">快速 (100ms 超时)</SelectItem>
                  ...
                  <div>
                    <Label htmlFor="timeout">超时设置 (毫秒)</Label>
                    <Slider
                      id="timeout"
                      min={100}
                      max={5000}
                  ...
                  <div>
                    <Label htmlFor="concurrent-scans">并发扫描数</Label>
                    <Slider
                      id="concurrent-scans"
                      min={1}
                      max={100}
