              ...
              <DialogHeader>
                <DialogTitle className="flex justify-between items-center mb-4 text-xl font-semibold">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>关闭对话框</TooltipContent>
                  </Tooltip>
                </DialogTitle>
              </DialogHeader>
                ...
                <>
                  <Card className="mb-4">
                    <CardHeader className="flex items-center">
                      <Avatar>
                        <AvatarImage src={selectedFile ? URL.createObjectURL(selectedFile as unknown as Blob) : undefined} />
                        <AvatarFallback>{selectedFile ? selectedFile.name.charAt(0).toUpperCase() : "F"}</AvatarFallback>
                      </Avatar>
                      <Label className="ml-4 font-medium" htmlFor="file">
                        选择文件
                      </Label>
                    </CardHeader>
                    <CardContent>
