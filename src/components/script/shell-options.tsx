      ...
      <AccordionItem value="features">
        ...
        <AccordionContent>
          <div className="space-y-4">
            ...
            {/* 更多功能选项 */}
            <div className="flex items-center justify-between">
              <Label htmlFor="enable-hover-highlight">启用悬停高亮</Label>
              <Switch
                id="enable-hover-highlight"
                checked={options.enableHoverHighlight}
                onCheckedChange={(checked) =>
                  updateOption("enableHoverHighlight", checked)
                }
              />
            </div>
            <div className="flex items-center justify-between">
              <Label htmlFor="enable-auto-save">开启自动保存</Label>
              <Switch
                id="enable-auto-save"
                checked={options.enableAutoSave}
                onCheckedChange={(checked) =>
                  updateOption("enableAutoSave", checked)
                }
              />
            </div>
          </div>
