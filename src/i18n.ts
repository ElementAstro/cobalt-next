...
const resources = {
  en: {
    translation: {
      ...
      versatileFunctionalityDesc: "Supports full-spectrum application from image acquisition to device management and system operations.",
      modernCpp: "Modern C++ Standard",
      modernCppDesc: "Built using the latest C++20 standard with compatibility for select C++23 features.",
      dynamicModuleLoading: "Dynamic Module Loading",
      dynamicModuleLoadingDesc: "Enables hot updates through C++ dynamic libraries for instant expansion of capabilities.",
      embeddedScripting: "Embedded Scripting",
      embeddedScriptingDesc: "Integrates a high-performance pocketpy interpreter supporting Python scripts.",
      crossPlatform: "Cross-Platform",
      crossPlatformDesc: "Fully supports Windows and Linux environments, with partial support for macOS.",
      comprehensiveAPIs: "Comprehensive APIs",
      comprehensiveAPIsDesc: "Offers a wide range of APIs and functional components for diverse astronomical imaging needs.",
      openSource: "Open-Source",
      openSourceDesc: "Adheres to the GPLv3 license, fostering community sharing and collaboration.",
      educational: "Educational",
      educationalDesc: "Encourages learning and innovation through high-quality code examples and documentation.",
  ...
  zh: {
    translation: {
      ...
      versatileFunctionalityDesc: "支持从图像采集到设备管理和系统操作的全方位应用。",
      modernCpp: "现代 C++ 标准",
      ...
      comprehensiveAPIsDesc: "提供广泛的 API 和功能组件，满足多样化的天文成像需求。",
      openSource: "开源",
